...
class SplitOrder {
  ...
  /// Base MDR without UPI Splitter (0.4% on full transaction if > ₹2,000, capped at ₹300 for >= 75k)
  ...
  /// MDR with UPI Splitter (0% since each tranche <= ₹2,000)
  double get mdrWithUpisplitter => 0.0;

  /// Net savings achieved (100% of Base MDR + 18% GST retained)
  double get mdrSavings => double.parse((totalStandardFee - mdrWithUpisplitter).toStringAsFixed(2));
